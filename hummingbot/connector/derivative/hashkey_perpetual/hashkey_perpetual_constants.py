...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=ORDERS_1SEC, limit=10, time_interval=10),
    # Weight Limits for individual endpoints
    RateLimit(limit_id=SNAPSHOT_PATH_URL, limit=LIMIT, time_interval=ONE_MINUTE),
    RateLimit(limit_id=TICKER_PRICE_URL, limit=LIMIT, time_interval=1),
              
    RateLimit(limit_id=TICKER_PRICE_CHANGE_URL, limit=LIMIT, time_interval=1),
              
    RateLimit(limit_id=EXCHANGE_INFO_URL, limit=LIMIT, time_interval=1),
            
    RateLimit(limit_id=RECENT_TRADES_URL, limit=LIMIT, time_interval=1),
              
    RateLimit(limit_id=USER_STREAM_PATH_URL, limit=LIMIT, time_interval=1),
            
    RateLimit(limit_id=PING_URL, limit=LIMIT, time_interval=1),
    ...
    RateLimit(limit_id=ACCOUNT_TRADE_LIST_URL, limit=LIMIT, time_interval=1),
              
    RateLimit(limit_id=SET_LEVERAGE_URL, limit=LIMIT, time_interval=1),
    ...
    RateLimit(limit_id=INDEX_PRICE_URL, limit=LIMIT, time_interval=1),
              
    RateLimit(limit_id=FUNDING_INFO_URL, limit=LIMIT, time_interval=1)
